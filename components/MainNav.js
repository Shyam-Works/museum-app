...
export default function MainNav() {
  ...
  return (
    <>
      <Navbar className="fixed-top navbar-dark " expanded={isExpanded} expand="lg" style={{ backgroundColor: '#002b36' }}>
        <Navbar.Brand className="ms-5">Shyam Patel</Navbar.Brand>
            ...
            {token && (
                <>
                    <Form className="d-flex" onSubmit={handleSubmit}>
                        ...
                        />
                        <Button type="submit" variant="outline-light" className="btn btn-primary">Search</Button>
                    </Form>
                    &nbsp;
                    <Nav>
